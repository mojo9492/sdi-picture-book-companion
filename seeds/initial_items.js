  ...
  return knex('items').del()
    .then(function () {
      ...
      return knex('items').insert([
        ...
        {nomenclature: 'Humvee Alternator / Generator 200 Amp', common: "Humvee Alternator", part_number: "12447109" , nsn: "2920-01-420-9968", accounting:  "", category: "vehicle parts", description: "Humvee alternator, 200 AMP"}
      ]);
    });
};
